...
public class OpenTransport
{
    ...
    public IPEndPoint? BoundLocalEndPoint { get; private set; }
    ...
    public async Task<Result> StartAsync()
    {
        ...
        try
        {
            ...
            bootstrap
                ...
                .LocalAddress(Request.LocalAddress, freePort.Value);

            _serverChannel = await bootstrap.BindAsync().ConfigureAwait(false);
            BoundLocalEndPoint = _serverChannel.LocalAddress as IPEndPoint;
            _isRunning = true;
