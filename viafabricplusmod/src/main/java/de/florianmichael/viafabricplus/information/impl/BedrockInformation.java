...
import de.florianmichael.viafabricplus.protocolhack.util.VersionRange;
...
public class BedrockInformation extends AbstractInformationGroup {
    ...
    public String formatMovementMode(final ServerAuthMovementMode movementMode) {
        if (movementMode == ServerAuthMovementMode.ClientAuthoritative) return "Client";
        if (movementMode == ServerAuthMovementMode.ServerAuthoritative) return "Server";
