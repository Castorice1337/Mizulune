...
public class ProtocolHack {
    ...
    public static void init() {
        // ViaBedrock is intentionally not bootstrapped in this 1.20.1 fork. Its private
        // packet lambdas are not ABI-stable across snapshots; Java/Legacy/AprilFools
        // support must remain usable even when the bundled Bedrock library changes.
        ViaLoader.init(new ViaFabricPlusViaVersionPlatformImpl(ViaFabricPlus.RUN_DIRECTORY), new ViaFabricPlusVLLoader(), new ViaFabricPlusVLInjector(), new ViaFabricPlusVLCommandHandler(), ViaBackwardsPlatformImpl::new, ViaFabricPlusViaLegacyPlatformImpl::new, ViaAprilFoolsPlatformImpl::new);
        initCommands();
