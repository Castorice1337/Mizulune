...
namespace {
void logStartupDebug(bool maxHookStaged, const QString& maxHookStatus) {
    ...
    out << "res/bg         = "
        ...
        << "\n";
    out << "maxHookStaged  = " << (maxHookStaged ? "true" : "false") << "\n";
    if (!maxHookStatus.isEmpty()) out << "maxHookStatus  = " << maxHookStatus << "\n";
}
} // namespace
...
int main(int argc, char** argv) {
    ...
    QString maxHookStatus;
    const bool maxHookStaged = loader::ProfileStore::stagePackagedMaxHook(&maxHookStatus);
    logStartupDebug(maxHookStaged, maxHookStatus);
