...
public class Scaffold extends Module implements RotationProvider {
    ...
    protected void onDisable() {
        ...
        if (mc.options != null && mc.getWindow() != null) {
            boolean physicalShift = InputConstants.isKeyDown(
                    ...
                    mc.options.keyShift.key.getValue());
            boolean physicalSprint = InputConstants.isKeyDown(
                    mc.getWindow().getWindow(),
                    mc.options.keySprint.key.getValue());
            mc.options.keyShift.setDown(physicalShift);
            KeyMapping.set(mc.options.keySprint.key, physicalSprint);
    ...
    private DirectionalInput capturePhysicalDirectionalInput() {
        ...
        return new DirectionalInput(
                InputConstants.isKeyDown(window, mc.options.keyUp.key.getValue()),
                InputConstants.isKeyDown(window, mc.options.keyDown.key.getValue()),
                InputConstants.isKeyDown(window, mc.options.keyLeft.key.getValue()),
                InputConstants.isKeyDown(window, mc.options.keyRight.key.getValue()));
    }
