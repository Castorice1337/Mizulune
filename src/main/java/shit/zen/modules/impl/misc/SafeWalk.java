...
extends Module {
    ...
    private void restorePhysicalShift() {
        ...
        boolean keyDown = InputConstants.isKeyDown(mc.getWindow().getWindow(), mc.options.keyShift.key.getValue());
    ...
    private boolean isPhysicalShiftDown() {
        ...
        return InputConstants.isKeyDown(mc.getWindow().getWindow(), mc.options.keyShift.key.getValue());
    }
    ...
    private boolean isKeyDown(KeyMapping keyMapping) {
        return InputConstants.isKeyDown(mc.getWindow().getWindow(), keyMapping.key.getValue());
    }
