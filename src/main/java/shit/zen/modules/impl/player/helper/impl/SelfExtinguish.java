...
extends HelperBase {
    ...
    public InteractionResult useItem(Player player, Level level, InteractionHand interactionHand) {
        ...
        InteractionResult loaderResult = ClientPlatforms.current().onItemRightClick(player, interactionHand);
        ...
        if (resultStack != heldStack) {
            ...
            if (resultStack.isEmpty()) {
                ClientPlatforms.current().onPlayerDestroyItem(player, heldStack, interactionHand);
            }
        }
