...
extends Module {
    ...
    private final NumberValue clickDelaySetting = new NumberValue("Delay", 200, 0, 1000, 10);
    private final NumberValue openDelaySetting = new NumberValue("Open Delay", 2, 0, 10, 1);
    private final BooleanValue chestSetting = new BooleanValue("Chest", true);
    private final BooleanValue enderChestSetting = new BooleanValue("Ender Chest", false);
    private final BooleanValue furnaceSetting = new BooleanValue("Furnace", true);
    private final BooleanValue brewingStandSetting = new BooleanValue("BrewingStand", true);
    private final BooleanValue pickTrashSetting = new BooleanValue("PickTrash", false);
    private final BooleanValue onlyBestSetting = new BooleanValue("Only Best", true);
    private final BooleanValue randomClickSetting = new BooleanValue("Random Click", false);
    private final BooleanValue smartStealingSetting = new BooleanValue("Smart Stealing", true);
    private final BooleanValue silentOnIsland = new BooleanValue("Silent On Island", false);
