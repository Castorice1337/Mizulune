...
public class WTap extends Module {
    ...
    private void applySprintTapSuppression() {
        ...
        if (this.simulateClicks.getValue()) {
            KeyMapping.set(mc.options.keySprint.key, false);
            KeyMapping.set(mc.options.keyUp.key, false);
        }
    }
    ...
    private void applyMovementBlockSuppression() {
        ...
        if (this.simulateClicks.getValue()) {
            KeyMapping.set(mc.options.keySprint.key, false);
            KeyMapping.set(mc.options.keyUp.key, false);
            KeyMapping.set(mc.options.keyDown.key, false);
            KeyMapping.set(mc.options.keyLeft.key, false);
            KeyMapping.set(mc.options.keyRight.key, false);
        }
    }
    ...
    private void stopTap() {
        ...
        if (mc.options != null && this.simulateClicks.getValue()) {
            KeyMapping.set(mc.options.keySprint.key, this.savedSprintKeyDown);
            KeyMapping.set(mc.options.keyUp.key, this.savedForwardKeyDown);
            KeyMapping.set(mc.options.keyDown.key, this.savedBackKeyDown);
            KeyMapping.set(mc.options.keyLeft.key, this.savedLeftKeyDown);
            KeyMapping.set(mc.options.keyRight.key, this.savedRightKeyDown);
        }
