...
extends HudElement {
    ...
    public void onGlRenderDirect(GlRenderEvent glRenderEvent) {
        ...
        GlHelper.drawTextShadowLegacy("M", 4.0f, 4.0f, fontRenderer, ColorUtil.getRainbowColor(10, 1).getRGB());
        GlHelper.drawTextShadowLegacy("izulune (" + mc.getFps() + "FPS)", 4.0f + GlHelper.getStringWidth("M", fontRenderer), 4.0f, fontRenderer, -1);
